...
EXEC CitiesP @CitiesTBAction = 0,@CityName = 'Kvareli', @CityPostIndex = 0172
SELECT * FROM CitiesTB

SELECT * FROM CitiesTBLogs

EXEC CitiesP @CitiesTBAction = 1, @CityName = 'Kvareli', @CityPostIndex = 0170, @CityID = 8
